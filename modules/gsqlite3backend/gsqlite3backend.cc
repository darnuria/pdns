...
gSQLite3Factory::gSQLite3Factory( const std::string & mode ) : BackendFactory( mode ), d_mode( mode )
{
}

//! Declares all needed arguments.
void gSQLite3Factory::declareArguments(const std::string & suffix) {
...
DNSBackend * gSQLite3Factory::make( const string & suffix)
{
